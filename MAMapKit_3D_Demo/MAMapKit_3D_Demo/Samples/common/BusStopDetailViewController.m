...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            ...
            case 2: subTitle = self.busStop.sequence; break;
            case 3: subTitle = self.busStop.citycode;        break;
            case 4: subTitle = self.busStop.adcode;          break;
            case 5: subTitle = [self.busStop.location description]; break;
            default: break;
        }
    }
    else
...
{
    return (section == 0) ? 6 : self.busStop.buslines.count;
}
