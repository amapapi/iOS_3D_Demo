...
- (NSString *)titleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            ...
            case 5: title = @"首发站";     break;
            case 6: title = @"终点站";     break;
            default: break;
        }
    }
    else if (indexPath.section == 1)
    {
        switch (indexPath.row)
        {
            ...
            case 10:title = @"下车站";       break;
            default:break;
        }
    }
    else
    {
        AMapBusStop *busStop = self.busLine.viaBusStops[indexPath.row];
...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            ...
            case 5: subTitle = self.busLine.startStop; break;
            case 6:subTitle = self.busLine.endStop;   break;
            default: break;
        }
    }
    else if (indexPath.section == 1)
    {
        switch (indexPath.row)
        {
            ...
            case 8: subTitle = [NSString stringWithFormat:@"%ld", (long)self.busLine.viaBusStops.count];    break;
            case 9: subTitle = self.busLine.departureStop.name;                                break;
            case 10:subTitle = self.busLine.arrivalStop.name;                                  break;
            default: break;
        }
    }
    else
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        busStop = self.busLine.viaBusStops[indexPath.row];
    }
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    {
        return self.busLine.viaBusStops.count;
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 2 || (indexPath.section == 1 && (indexPath.row == 9 || indexPath.row == 10)))
    {
