...
-(void)addCarAnnotationWithCoordinate:(CLLocationCoordinate2D)coordinate
{
    ...
    self.animatedCarAnnotation.subtitle         = [NSString stringWithFormat:@"Car: %d images",[self.animatedCarAnnotation.animatedImages count]];
...
-(void)addTrainAnnotationWithCoordinate:(CLLocationCoordinate2D)coordinate
{
    ...
    self.animatedTrainAnnotation.subtitle       = [NSString stringWithFormat:@"Train: %d images",[self.animatedTrainAnnotation.animatedImages count]];
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [self.mapView selectAnnotation:self.animatedCarAnnotation animated:YES];
}
