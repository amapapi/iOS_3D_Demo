...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row)
    {
        ...
        case 5  : subTitle = [NSString stringWithFormat:@"%d", self.groupBuy.num];              break;
        case 6  : subTitle = [NSString stringWithFormat:@"%d", self.groupBuy.soldNum];          break;
        ...
        case 12 : subTitle = [NSString stringWithFormat:@"%d张图", self.groupBuy.photos.count];                     break;
