...
- (NSString *)titleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        title = [NSString stringWithFormat:@"%d米 %@", tmc.distance, statusStr];
    }
...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            ...
            case 3: subTitle = [NSString stringWithFormat:@"%d(米)", self.step.distance]; break;
            case 4: subTitle = [NSString stringWithFormat:@"%d(秒)", self.step.duration]; break;
            ...
            case 9: subTitle = [NSString stringWithFormat:@"%d(米)", self.step.tollDistance]; break;
