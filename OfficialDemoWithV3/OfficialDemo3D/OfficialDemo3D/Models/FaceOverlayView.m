...
- (void)drawCircleWithPoints:(CGPoint *)points pointCount:(NSUInteger)pointCount
{
    ...
    /* Drawing outline. */
    [self renderLinesWithPoints:points pointCount:pointCount strokeColor:self.strokeColor lineWidth:[self glWidthForWindowWidth:self.lineWidth] looped:YES lineDash:self.lineDash];
}
...
- (void)drawLineWithPoints:(CGPoint *)points pointCount:(NSUInteger)pointCount
{
    ...
    /* Drawing line. */
    [self renderLinesWithPoints:points pointCount:pointCount strokeColor:self.strokeColor lineWidth:[self glWidthForWindowWidth:self.lineWidth] looped:NO lineDash:self.lineDash];
}
